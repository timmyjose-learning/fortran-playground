...
contains
   ...
   subroutine test_is_sorted_asc()
      ...
      call assert_false(is_sorted(arr), 'insertion sort/test_is_sorted_asc')
      call insertion_sort(arr)
      call assert_true (is_sorted(arr), 'insertion sort/test_is_sorted_asc')
   ...
   subroutine test_is_sorted_desc()
      ...
      call assert_false(is_sorted(arr), 'insertion sort.test_is_sorted_desc')
      call insertion_sort(arr, cmp=is_greater)
      call assert_true (is_sorted(arr, cmp=is_greater), 'insertion sort/test_is_sorted_desc')
