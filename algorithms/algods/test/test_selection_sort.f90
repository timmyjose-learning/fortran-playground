program test_selection_sort
   ...
   use selection_sort_m, only: selection_sort
   implicit none
...
contains
   ...
   subroutine test_is_sorted_asc()
      ...
      call assert_false(is_sorted(arr), 'selection sort/test_is_sorted_asc')
      call selection_sort(arr)
      call assert_true (is_sorted(arr), 'selection sort/test_is_sorted_asc')
   ...
   subroutine test_is_sorted_desc()
      ...
      call assert_false(is_sorted(arr), 'selection sort.test_is_sorted_desc')
      call selection_sort(arr, cmp=is_greater)
      call assert_true (is_sorted(arr, cmp=is_greater), 'selection sort/test_is_sorted_desc')
